...
namespace AppLocaleLib
{
	public class LocaleManaged
	{
		...
		[DllImport(@"kernel32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
		public static extern bool EnumSystemLocalesEx(EnumLocalesProcExDelegate pEnumProcEx, LOCALETYPE dwFlags, int lParam,
			IntPtr lpReserved);

		// ReSharper disable InconsistentNaming
		public const uint LOCALE_SYSTEM_DEFAULT = 0x800;
		public const uint LOCALE_USER_DEFAULT = 0x400;
